      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center gap-6 text-black font-medium">
            ...
            <Link to="/immersive" className="hover:text-peach-700 transition-colors duration-300">
              Immersive
            </Link>
            <Link to="/marketplace" className="hover:text-peach-700 transition-colors duration-300">
              Marketplace
            </Link>
            <Link to="/events" className="hover:text-peach-700 transition-colors duration-300">
              Events
            </Link>
            <Link
              to="/geo-transit-live"
        ...
        {mobileOpen && (
          <div className="md:hidden flex flex-col gap-4 mt-4 pb-4 text-black font-medium animate-fade-in-down">
            ...
            <Link to="/immersive" className="hover:text-peach-700 transition-colors duration-300" onClick={() => setMobileOpen(false)}>
              Immersive
            </Link>
            <Link to="/marketplace" className="hover:text-peach-700 transition-colors duration-300" onClick={() => setMobileOpen(false)}>
              Marketplace
            </Link>
            <Link to="/events" className="hover:text-peach-700 transition-colors duration-300" onClick={() => setMobileOpen(false)}>
              Events
            </Link>
            <Link
              to="/geo-transit-live"
